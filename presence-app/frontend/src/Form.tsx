...
function Form() {
  ...
  return (
    <>
      <form onSubmit={handleSubmit} className="px-6 py-8 space-y-6 max-w-md mx-auto">
        <div>
        ...
        <div>
          ...
          <PhoneInput
            ...
            inputClass="!border-gray-300 focus:!bg-white focus:!shadow-md !bg-gray-50 !transition-all !duration-1000 !rounded-xl !border !text-sm focus:!ring-2 focus:!ring-blue-500 focus:!border-blue-500 !block !w-full !pr-2.5 !pl-14 !py-2 !shadow-sm placeholder:!text-gray-400 !h-auto"
        ...
        <div className="flex justify-center">
          <button type="submit" className="bg-brand box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs leading-5 rounded-base text-sm px-4 py-3.5 focus:outline-none bg-sky-500 rounded-2xl text-amber-50 mt-8 hover:bg-blue-600 active:scale-95 hover:shadow-xl font-semibold tracking-wide ">
            Soumettre
          </button>
        </div>
      </form>
